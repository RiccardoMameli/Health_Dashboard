...
| D13 | Baseline window | **Prefer 30 days, widen to 180 when sparse** | Changed 14 Sep, widened 15 Sep after measuring 2,041 days: 30 alone 27.4%, 90 30.8%, 180 36.1%, 365 46.2%. 180 keeps the window inside one seasonal half. Safe because the norm is stable (16 min between 2024 and 2025), and `span_days` is shown on the screen so an old baseline says so. |
